            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar space-y-4">
              ...
              <div className="bg-blue-50 rounded-2xl p-4 border border-blue-200">
                <p className="text-sm text-blue-800 font-semibold">
                  📅 Date Range: <span className="font-bold">{formatDate(occupancyData.dateRange.start)}</span> to <span className="font-bold">{formatDate(occupancyData.dateRange.end)}</span>
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Avg Consultation</h3>
                  ...
                  <p className="text-4xl font-bold text-gray-900 mb-2">{occupancyData.summary.avgConsultationOccupancy.toFixed(1)}%</p>
                  <p className="text-sm text-gray-500">of 16 slots/day</p>
                </div>

                {/* Average Treatment Occupancy */}
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Avg Treatment</h3>
                  ...
                  <p className="text-4xl font-bold text-gray-900 mb-2">{occupancyData.summary.avgTreatmentOccupancy.toFixed(1)}%</p>
                  <p className="text-sm text-gray-500">of 32 slots/day</p>
                </div>

                {/* Total Consultation Slots Used */}
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Total Consultations</h3>
                  ...
                  <p className="text-sm text-gray-500">slots used (30 days)</p>
                </div>

                {/* Total Treatment Slots Used */}
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Total Treatments</h3>
              ...
              {occupancyData.consultationChartData && occupancyData.consultationChartData.length > 0 && (
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
                  <h3 className="text-lg font-bold text-gray-900 mb-6">Consultation Occupancy Rate</h3>
              ...
              {occupancyData.procedureChartData && occupancyData.procedureChartData.length > 0 && occupancyData.procedureCodeNames.length > 0 && (
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
                  <h3 className="text-lg font-bold text-gray-900 mb-6">Treatment Occupancy by Procedure Code</h3>
                  <ResponsiveContainer width="100%" height={400}>
                    <BarChart data={occupancyData.procedureChartData}>
                      ...
                      <YAxis 
                        ...
                        allowDecimals={false}
                        domain={[0, 32]}
                        label={{ value: 'Number of Treatments', angle: -90, position: 'insideLeft' }}
                      />
                      <Tooltip 
                        labelFormatter={(label) => formatDate(label)}
                        contentStyle={{
              ...
              {occupancyData.dailyOccupancy.length > 0 && (
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">Daily Occupancy Breakdown</h3>
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Date</th>
                          <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Consultations</th>
                          <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Consultation Rate</th>
                          <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Treatments</th>
                          <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Treatment Rate</th>
                        </tr>
                      </thead>
